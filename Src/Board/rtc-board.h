...
/*!
 * \brief Writes Data from the RTC backup registers
 *
 * \param [IN] data Data to be written
 * \param [IN] data_type Data_type to be written
 */
 ...
 *
 * \param [IN] data_type Data_type to be read
 *
 * \retval Data from RTC backup register
 */
