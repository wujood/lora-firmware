...
/*!
 * Restore the RxDone Parameters from RTC-Backup-Register
 */
void RestoreRxDone(void);

/*!
 * Restore the MacCtx after Reset from Shutdown Mode
 */
void RestoreMacCtx(void);

/*!
 * Delete the RTC-Backup-Register
 */
void DeleteBackup(void);


/*!
 * \brief Returns the GetNetworkActivation from the RTC-Backup-Register
 *
 * \retval GetNetworkActivation from the RTC-Backup-Register
 */
